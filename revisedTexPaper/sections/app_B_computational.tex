...
This appendix documents the computational analysis. All scripts and figures are available in the project repository.
...
+-- supplemental_methodology.tex  # Research process documentation
\end{verbatim}
\end{small}
